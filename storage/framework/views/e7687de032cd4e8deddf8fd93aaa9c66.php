...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'IOMS'); ?> - IOMS</title>
    <link rel="icon" type="image/png" href="<?php echo e(asset('images/MSHCS_logo.png')); ?>" />
...
<div class="notification-toast notification-success show" id="notification-toast">
    ...
    <div class="notification-content">
        <div class="notification-message"><?php echo e(session('status')); ?></div>
    </div>
...
<div class="notification-toast notification-error show" id="notification-toast">
    ...
    <div class="notification-content">
        <div class="notification-message"><?php echo e(session('error')); ?></div>
    </div>
    <button class="notification-close" onclick="closeNotification()">
        <span data-feather="x"></span>
    </button>
...
<div class="notification-toast notification-deleted show" id="notification-toast">
    ...
    <div class="notification-content">
        <div class="notification-message"><?php echo e(session('deleted')); ?></div>
    </div>
    <button class="notification-close" onclick="closeNotification()">
        <span data-feather="x"></span>
    </button>
...
<!-- Dashboard JS -->
<?php echo app('Illuminate\Foundation\Vite')(['resources/js/dashboard.js', 'resources/js/spa-navigation.js']); ?>

<?php echo $__env->yieldPushContent('scripts'); ?>
</body>
</html>
<?php /**PATH E:\xampp\htdocs\IOMS\resources\views/layouts/dashboard.blade.php ENDPATH**/ ?>