        ...
        <section class="login-left" aria-label="Sign in">
            <div class="form-wrap">
                ...
                <div class="brand" style="margin-bottom:12px;">
                    <img src="<?php echo e(asset('images/MSHCS_logo.png')); ?>" alt="MSHCS Logo" />
                    ...
                    <div class="form-group">
                        <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:6px;">
                            ...
                            <?php if(Route::has('password.request')): ?>
                                <a href="<?php echo e(route('password.request')); ?>" class="text-green-600 hover:underline" style="font-size:13px;">
                                    Forgot Password
                                </a>
                            <?php endif; ?>
                        </div>
...
unset($__errorArgs, $__bag); ?>
        ...
        <aside class="login-right" aria-hidden="true">
            <img src="<?php echo e(asset('images/login-illustration.svg')); ?>" alt="Login Illustration" class="illustration" />
        </aside>
    </main>
</body>
</html>
<?php /**PATH E:\xampp\htdocs\IOMS\resources\views/auth/login.blade.php ENDPATH**/ ?>