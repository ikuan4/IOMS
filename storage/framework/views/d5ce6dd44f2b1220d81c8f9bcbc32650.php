...
<?php $__env->startSection('content'); ?>
    ...
    <div class="header-card">
        <div class="header-left">
            <h2>Manage Permissions: <?php echo e($role->name); ?></h2>
        ...
        <div style="display:flex;align-items:start;gap:12px;">
            ...
            <div>
                ...
                <p style="margin:0;font-size:13px;color:var(--text);line-height:1.5;opacity:0.9;">
                    Permissions are organized by module groups. <?php echo e($canEdit ? 'Toggle permissions for' : 'View permissions for'); ?> <strong><?php echo e($role->name); ?></strong> below.
                    <?php if($canEdit): ?>
    ...
    <form action="<?php echo e(route('roles.permissions.update', $role->id)); ?>" method="POST" id="permissions-form" <?php echo e(!$canEdit ? 'class=view-only style=opacity:0.6;' : ''); ?>>
        <?php echo csrf_field(); ?>
        ...
        <div class="card" style="margin-top:12px;">
            <div style="padding:16px 18px; border-bottom:1px solid #e5e7eb; display:flex; justify-content:space-between; align-items:center; flex-wrap:wrap; gap:10px;">
                <h5 style="margin:0; font-size:16px; font-weight:600;"><?php echo e($canEdit ? 'Assign' : 'View'); ?> Permissions</h5>
                <?php if($canEdit): ?>
            ...
            <div style="padding:16px;">
                ...
                <?php $__currentLoopData = $orderedPermissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group => $perms): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="permission-group" style="margin-bottom:24px;">
                        ...
                        <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:12px;padding-bottom:8px;border-bottom:2px solid #3b82f6;">
                            <div onclick="toggleModuleCollapse('<?php echo e($group); ?>')" style="display:flex;align-items:center;gap:8px;cursor:pointer;flex:1;">
                                <span
                                    id="module-chevron-<?php echo e($group); ?>"
                                ...
                                <h5 style="margin:0;font-size:15px;font-weight:600;color:#3b82f6;">
                                    ...
                                    ?>
                                    <span data-feather="<?php echo e($icon); ?>" style="width:18px;height:18px;"></span>
                                    <?php echo e(ucwords(str_replace('-', ' ', $group))); ?>

                                    <?php if($isFutureModule): ?>
                                        <span style=\"
                                            font-size:10px;
                                            font-weight:700;
                                            color:#f59e0b;
                            ...
                            <label class="toggle-switch" style="user-select:none;" onclick="event.stopPropagation();">
                                ...
                                <input
                                    class="module-toggle"
                                    type="checkbox"
                                    id="module-<?php echo e($group); ?>"
                                    data-group="<?php echo e($group); ?>"
                                    <?php echo e($hasAnyChecked ? 'checked' : ''); ?>
                        ...
                        <div id="module-content-<?php echo e($group); ?>" style="overflow:hidden;transition:max-height 0.3s ease;max-height:0px;">
                            <?php if($group === 'contracts'): ?>
                                ...
                                <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(250px,1fr));gap:12px;margin-top:12px;" data-module-group="<?php echo e($group); ?>">
                                <?php $__currentLoopData = $mainPerms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $permission): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div style="
                                        background:white;
                                        ...
                                        gap:12px;
                                    " class="permission-card<?php echo e(!$hasAnyChecked ? ' disabled' : ''); ?>" data-module="<?php echo e($group); ?>">
                                        <div>
                                            <strong style="font-size:14px;display:block;margin-bottom:4px;"><?php echo e($permission->name); ?></strong>
                                            <?php if($permission->description): ?>
                                                <span style="font-size:12px;color:#6b7280;"><?php echo e($permission->description); ?></span>
                                            <?php endif; ?>
                                        </div>
                                        <label class="toggle-switch" style="flex-shrink:0;">
                                            <input
                                                ...
                                                data-group="<?php echo e($group); ?>"
                                                data-permission="<?php echo e($permission->slug); ?>"
                                ...
                                <?php if($additionalPerms->count() > 0): ?>
                                <div style="margin:16px 0;border-top:1px dashed #d1d5db;"></div>

                                
                                <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(250px,1fr));gap:12px;" data-module-group="<?php echo e($group); ?>">
                                <?php $__currentLoopData = $additionalPerms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $permission): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div style="
                                        background:white;
                                        border:1px solid #e5e7eb;
                                        border-radius:8px;
                            ...
                            <?php elseif($group === 'roles'): ?>
                                ...
                                <?php if($hierarchyPerms->count() > 0): ?>
                                <div style="margin:16px 0;border-top:1px dashed #d1d5db;"></div>

                                
                                <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(250px,1fr));gap:12px;" data-module-group="<?php echo e($group); ?>">
                                <?php $__currentLoopData = $hierarchyPerms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $permission): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div style="
                                        background:white;
                                        border:1px solid #e5e7eb;
                                        border-radius:8px;
    ...
    <div class="card" style="margin-top:12px;">
        <div style="padding:16px;">
            ...
            <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(150px,1fr));gap:16px;text-align:center;">
                <div>
                    <h3 style="margin:0;font-size:28px;font-weight:bold;color:#3b82f6;" id="total-permissions"><?php echo e(count($rolePermissions)); ?></h3>
                    <p class="muted" style="margin:4px 0 0 0;font-size:13px;">Permissions Assigned</p>
                </div>
                <div>
                    <h3 style="margin:0;font-size:28px;font-weight:bold;color:#6b7280;"><?php echo e(array_sum(array_map('count', $permissions->toArray()))); ?></h3>
                ...
                <div>
                    <h3 style="margin:0;font-size:28px;font-weight:bold;color:#0ea5e9;" id="coverage-percentage">
                        <?php echo e(array_sum(array_map('count', $permissions->toArray())) > 0 ? round((count($rolePermissions) / array_sum(array_map('count', $permissions->toArray()))) * 100) : 0); ?>%
                    </h3>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const canEdit = <?php echo e($canEdit ? 'true' : 'false'); ?>;
    if (!canEdit) {
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\xampp\htdocs\IOMS\resources\views/roles/permissions.blade.php ENDPATH**/ ?>