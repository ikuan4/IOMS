<header class="global-header"
    ...
    <div style="display:flex; align-items:center; gap:12px; flex-shrink:0;">
        ...
        <a href="<?php echo e(route('dashboard')); ?>" style="display:flex; align-items:center;">
            <img src="<?php echo e(asset('images/MSHCS_logo.png')); ?>"
                 alt="MSHCS Logo"
        ...
        <?php if(auth()->guard()->check()): ?>
            <div class="user-menu">
                ...
                >
                    <div class="avatar">
                        <?php if($user->avatar): ?>
                            <img src="<?php echo e(asset('storage/'.$user->avatar)); ?>" alt="<?php echo e($user->name); ?>'s avatar" style="width:100%;height:100%;object-fit:cover;border-radius:50%;display:block;" />
                        <?php else: ?>
...
<?php $__env->stopPush(); ?>
<?php /**PATH E:\xampp\htdocs\IOMS\resources\views/partials/header.blade.php ENDPATH**/ ?>