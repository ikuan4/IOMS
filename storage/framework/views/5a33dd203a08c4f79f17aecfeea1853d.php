<?php $__env->startSection('title', 'Ticket Modules'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div style="margin-top:12px;">
        <div style="display:grid;grid-template-columns:repeat(auto-fit, minmax(200px, 1fr));gap:16px;">
            <?php $__currentLoopData = $cards; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $card): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <a href="<?php echo e(route('ticket-modules.index', $params)); ?>" style="text-decoration:none;color:inherit;">
    ...
    <div class="header-right" style="display:flex;gap:12px;align-items:flex-end; margin-top:16px; flex-wrap:wrap;">
        <form method="GET" action="<?php echo e(route('ticket-modules.index')); ?>" id="ticketModuleSearchForm" style="display:flex;gap:12px;align-items:flex-end; flex-wrap:wrap;">
            ...
            <input type="text" name="search" id="ticketModuleSearchInput" value="<?php echo e($search); ?>" placeholder="Search by name or description..." oninput="debouncedTicketModuleSearch()" style="padding:14px 16px;border-radius:10px;border:1px solid #d0d7e0;min-width:330px;width:330px;font-size:15px;" />
        </form>

        <?php if(auth()->user()->isSuperAdmin() || auth()->user()->can('create', \App\Models\TicketModule::class)): ?>
            <a href="<?php echo e(route('ticket-modules.create')); ?>" style="background:#22c55e;color:white;padding:10px 24px;border-radius:10px;font-weight:1000;width:220px;display:flex;justify-content:center;align-items:center;gap:8px;white-space:nowrap;text-decoration:none;">
    ...
    <div class="card" style="margin-top:12px;overflow:hidden;">
        <div id="ticketModulesTableWrapper">
            <?php echo $__env->make('ticket-modules._ticket_modules_table', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        </div>
    </div>
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\xampp\htdocs\IOMS\resources\views/ticket-modules/index.blade.php ENDPATH**/ ?>