...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input id="email" name="email" type="email" value="<?php echo e(old('email', $user->email)); ?>" autocomplete="email" style="width:100%;padding:14px 16px;border-radius:10px;border:1px solid #d0d7e0;font-size:15px;">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div style="margin-top:10px;display:flex;gap:10px;flex-wrap:wrap;">
                        ...
                        <a href="<?php echo e(route('dashboard')); ?>" style="background:#64748b;color:rgb(253,253,253);padding:14px 24px;border-radius:10px;font-weight:1000;font-size:15px;text-decoration:none;display:flex;align-items:center;gap:8px;"><span data-feather="arrow-left"></span> Back to Dashboard</a>
                    </div>
                ...
                <div class="profile-form-right" style="min-width:260px;display:flex;align-items:stretch;justify-content:center;flex:1 1 420px;">
                    <div style="padding:8px;border-radius:10px;background:var(--card, #fff);text-align:center;display:flex;flex-direction:column;align-items:center;justify-content:center;width:420px;box-sizing:border-box;margin:0 auto;">
                        ...
                        <div id="avatarPreviewContainer" style="width:320px;height:320px;margin:0 auto;border-radius:6px;overflow:hidden;display:flex;align-items:center;justify-content:center;background:var(--muted-bg,#f3f4f6);position:relative;">
                            <img id="avatarPreview" src="<?php echo e($user->avatar ? asset('storage/'.$user->avatar) : ''); ?>" alt="<?php echo e($user->name); ?> avatar" style="max-width:100%;max-height:100%;display:<?php echo e($user->avatar ? 'block' : 'none'); ?>;object-fit:cover;" />
                            <div id="avatarIcon" style="position:absolute;display:<?php echo e($user->avatar ? 'none' : 'flex'); ?>;align-items:center;justify-content:center;width:100%;height:100%;">
                        ...
                        <div style="margin-top:12px;display:flex;flex-direction:column;align-items:center;gap:8px;">
                            ...
                            <div id="avatarFilename" style="font-size:13px;color:var(--muted,#6b7280);display:<?php echo e($user->avatar ? 'block' : 'none'); ?>;"><?php echo e($user->avatar ? basename($user->avatar) : ''); ?></div>
                        </div>
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\xampp\htdocs\IOMS\resources\views/users/profile.blade.php ENDPATH**/ ?>