...
<?php $__env->startSection('content'); ?>
    ...
    <div style="margin-top:12px;">
        <div id="userCardsContainer" style="display:grid;grid-template-columns:repeat(auto-fit, minmax(200px, 1fr));gap:16px;">
            <?php $__currentLoopData = $cards; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $card): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <a href="<?php echo e(route('users.index', $params)); ?>" class="user-filter-card" style="text-decoration:none;color:inherit;">
    ...
    <div class="header-right" style="display:flex;gap:12px;align-items:flex-end; margin-top:16px;">
        <form method="GET" action="<?php echo e(route('users.index')); ?>" id="searchForm" style="display:flex;gap:12px;align-items:flex-end; flex-wrap:wrap;">
            ...
            <input type="text" name="search" id="userSearchInput" value="<?php echo e($search); ?>" placeholder="Search by name, mobile, or email..." oninput="debouncedUserSearch()" style="padding:14px 16px;border-radius:10px;border:1px solid #d0d7e0;min-width:330px;width:330px;font-size:15px;" />
        </form>

        <?php if(env('DEV_SHOW_ACTIONS', false) || auth()->user()->can('create', \App\Models\User::class)): ?>
        <a href="<?php echo e(route('users.create')); ?>" style="background:#22c55e;color:white;padding:10px 24px;border-radius:10px;font-weight:1000;width:220px;display:flex;justify-content:center;align-items:center;gap:8px;white-space:nowrap;text-decoration:none;">
    ...
    <div class="card" style="margin-top:12px; overflow-x:auto;">
        <div id="usersTableWrapper">
            <?php echo $__env->make('users._users_table', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        </div>
    </div>
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\xampp\htdocs\IOMS\resources\views/users/index.blade.php ENDPATH**/ ?>