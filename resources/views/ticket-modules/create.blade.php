...
@section('title', 'Create Ticket Module')

@section('content')
    <div class="header-card">
        <div class="header-left">
            <h2>Add Ticket Module</h2>
            <p class="muted">Create a new ticket module.</p>
        </div>
    </div>
            ...
            <div style="display:flex;flex-direction:column;gap:18px;max-width:600px;">
                ...
                <div>
                    ...
                    <input
                        ...
                        placeholder="e.g., Contracts, Users, Branches"
                    >
                    @error('name')
                ...
                <div>
                    ...
                    <textarea
                        ...
                        rows="4"
                        style="width:100%;padding:14px 16px;border-radius:10px;border:1px solid #d0d7e0;font-size:15px;"
                        placeholder="Optional description of this ticket module"
