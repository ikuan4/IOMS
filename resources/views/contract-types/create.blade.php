...
@section('content')
    <div class="header-card">
        <div class="header-left">
            ...
            <p class="muted">Create a new contract type.</p>
        </div>
    </div>
        ...
        <div class="card" style="margin-top:16px;">
            <div style="display:flex;flex-direction:column;gap:18px;max-width:600px;">
                ...
                <div>
                    ...
                    @enderror
                    <p class="muted" style="font-size:13px;margin-top:6px;">A unique 3-character code will be auto-generated from this name.</p>
                </div>
